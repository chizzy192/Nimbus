    ...
    <main className="min-h-screen bg-grid">
      ...
      <nav className="sticky top-0 z-40 border-b border-[var(--border)] bg-[var(--bg)]/85 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden items-center gap-8 md:flex">
            <Link href="#how" className="font-body text-sm text-nimbus-300 hover:text-text">
              How it works
            </Link>
            <Link href="#oracle" className="font-body text-sm text-nimbus-300 hover:text-text">
              The Oracle
            </Link>
            <Link href="#sponsors" className="font-body text-sm text-nimbus-300 hover:text-text">
              For sponsors
            </Link>
            <Link href="/admin" className="font-body text-sm text-nimbus-300 hover:text-text">
              Admin
            </Link>
          </div>
          <Link href="/farmer/register" className="btn-primary text-sm">
            Enroll your farm
          </Link>
        </div>
      </nav>
      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:py-28">
        <div className="flex flex-col justify-center">
          ...
          <h1 className="font-display text-5xl leading-[1.05] text-text md:text-7xl">
            When rain fails,
            <br />
            <span className="text-nimbus-400">Nimbus pays.</span>
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/farmer/register" className="btn-primary">
              Enroll a farm
            </Link>
      ...
      <section id="how" className="mx-auto max-w-7xl px-6 py-24">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          {[
            { n: '01', t: 'Register', d: 'Farmer enrolls with phone + GPS pin. A custodial Stellar wallet is generated.' },
            ...
            <ul className="space-y-5">
              {[
                ...
                <li key={b.t} className="flex gap-4">
                  <span className="mt-1 h-2 w-2 shrink-0 rounded-full bg-nimbus-500 shadow-[0_0_10px_rgba(16,185,129,0.7)]" />
                  <div>
      ...
      <section id="sponsors" className="mx-auto max-w-7xl px-6 py-24">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="card p-8">
            ...
            <Link href="/admin" className="mt-6 inline-block btn-ghost text-sm">
              Sponsor a region →
            </Link>
          </div>
          <div className="card p-8">
      ...
      <section className="mx-auto max-w-7xl px-6 py-28">
        <div className="card relative overflow-hidden p-16 text-center">
          <div className="relative">
            ...
            <p className="mx-auto mt-6 max-w-xl font-body text-nimbus-300">
              Help us put parametric coverage in every village. Enroll a farm or fund a pool today.
            </p>
